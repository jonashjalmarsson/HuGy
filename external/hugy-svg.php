...
class HuGySVG {
    static public function get($type) {
        ...
        switch($type) {
            ...
            case 'schoolsoft':
                $viewBox = "0 0 80 80";
                $svg = '<path d="M24.1,40.46c-.11,6.88,4.63,13.29,11.24,15.16,10.19,2.88,20.27-4.68,20.57-15.16h9.11v.51c-.29,4.03-1.39,7.7-3.51,11.13-6.08,9.85-18.43,14.61-29.55,10.93-9.61-3.18-17.04-12.24-16.97-22.57h9.12Z"/>
                        <path d="M18.96,21.64c6.01-.74,6.92,8.3,1.41,9.05-6.44.87-7.22-8.33-1.41-9.05Z"/>
                        <path d="M59.46,21.64c6.59-1.13,7.4,8.61,1.19,9.05-5.57.4-6.55-8.14-1.19-9.05Z"/>';
                break;
