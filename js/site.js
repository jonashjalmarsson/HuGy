...
*/
			...
			if ($(window).scrollTop() - $(".top").height() > 0) {
				$("#wpadminbar").hide();
				//$(".top-wrapper").css("padding-bottom",$(".top-navigation-wrapper").height());
				$(".top-navigation-wrapper, .top-menu-button").addClass("fixed");
				//$(".main-menu").css("top",$(".top-navigation-wrapper").height());
			}
			else {
				//$(".top-wrapper").css("padding-bottom",0);
		...
		$(".top-menu-button").click(function(ev) {
			...
			/*if ($(this).hasClass("fixed")) {
				...
				$("body,html").animate({scrollTop: $(".pre-footer").position().top + $(".top-navigation-wrapper").height() },800);
			}
			else {
		...
		function(ev) {
			// close hover menu
			$(".main-menu .main-menu-wrapper").slideUp("fast");
		...
		if ($(".teaser-1").length > 0)
		{
			...
			$(".teaser-1").hover(function() {
				$(this).find("span").hugy_shake_text(2);
			},function() {});
		...
		if ($("body").hasClass("home"))
		{
			...
			$(".slides").before($("<div />").addClass("slide-layer").width(width).height(height));
...
(function($) {
	$.fn.capslide = function(options) {
		...
		return this.each(function() {
			...
			$('.ic_caption',$this).css({'color':o.caption_color,'background-color':o.caption_bgcolor,'bottom':'6px','width':w,'height':h});
...
/*
 * Facebook wall
 * http://beta.thomasclausen.dk/facebook-wall/
 * https://github.com/thomasclausen/jquery-facebook-wall/blob/master/facebook_wall.plugin.js
 */
(function($) {
        $.fn.facebook_wall = function(options) {
                ...
                options = $.extend({
                        ...
                        text_labels: {
                                ...
                                comment: 'Kommentera',
                                share: 'Dela',
                days: ['s&ouml;ndag', 'm&argin;ndag', 'tisdag', 'onsdag', 'torsdag', 'fredag', 'l&ouml;rdag'],
                ...
                time_difference = Math.round(new Date().getTime()/1000)-time;
                        ...
                        if (time_difference < 10) {
                                return 'F&aring; sekunder sedan';
                        } else if (time_difference < 60) {
                                return Math.round(time_difference) + ' sekunder sedan';
                        } else if (Math.round(time_difference/60) === 1) {
                                return Math.round(time_difference/60) + ' minut sedan';
                        } else if (Math.round(time_difference/60) < 60) {
                                return Math.round(time_difference/60) + ' minuter sedan';
                        } else if (Math.round(time_difference/(60*60)) === 1) {
                                return Math.round(time_difference/(60*60)) + ' timme sedan';
                        } else if (Math.round(time_difference/(60*60)) < 24) {
                                return Math.round(time_difference/(60*60)) + ' timmar sedan';
                        } else if (Math.round(time_difference/(60*60*24)) === 1) {
                                return Math.round(time_difference/(60*60*24)) + ' dag sedan';
                        } else if (Math.round(time_difference/(60*60*24)) <= 10) {
                                return Math.round(time_difference/(60*60*24)) + ' dagar sedan';
                        } else {
